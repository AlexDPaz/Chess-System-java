...
public class ChessMatch {
	...
	public ChessPiece performChessMove(ChessPosition sourcePosition, ChessPosition targetPosition) {
		...
		if (movedPiece instanceof Pawn) {
			if (movedPiece.getColor()==Color.WHITE && target.getRow() == 0 || movedPiece.getColor()==Color.BLACK && target.getRow() == 7) {
				promoted = (ChessPiece)board.piece(target);// primeiro jogar o peão para variavel rpomoted para depois chamar o replaccePromotedPiece 
				promoted = replacePromoPiece("Q");// se não a vairial promote estaria valendo null e não teria sentido trocar a peça promovida se não tem nenhuma peça a ser promovida 
			}
		}
	...
	public ChessPiece replacePromoPiece(String type) {
		//programação defenciva 
		if(promoted == null) {
			throw new IllegalStateException("There is not a piece to be promoted");
		}
		if (!type.equals("B") && !type.equals("N") && !type.equals("R") & !type.equals("Q")) {
			throw new InvalidParameterException("Invaled type for promoted");
		}
	...
	// metodo auxiliar para instaciar a peça especifica
